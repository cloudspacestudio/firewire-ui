...
@Component({
    standalone: true,
    imports: [FormsModule, MatDialogTitle, MatDialogContent, MatDialogActions, MatDialogClose, MatButtonModule, MatFormFieldModule, MatInputModule],
    template: `
        ...
        <mat-dialog-content class="pin-setup">
          ...
          @if (errorMessage) {
            <div class="pin-setup__error">{{errorMessage}}</div>
          }
        </mat-dialog-content>
